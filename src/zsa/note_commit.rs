...
impl<Lookup: PallasLookupRangeCheck> NoteCommitChip<Lookup> {
    ...
    pub(in crate::zsa) fn construct(config: NoteCommitConfig<Lookup>) -> Self {
        Self { config }
    }
}
...
pub(in crate::zsa) mod gadgets {
    ...
    #[allow(clippy::type_complexity)]
    #[allow(clippy::too_many_arguments)]
    pub(in crate::zsa) fn note_commit<Lookup: PallasLookupRangeCheck>(
...
mod tests {
    ...
    use crate::{
        circuit::gadget::{assign_free_advice, assign_is_zatoshi_asset},
        constants::{
        ...
        value::NoteValue,
        zsa::note_commit::{gadgets, NoteCommitChip, NoteCommitConfig, ZsaNoteCommitParams},
    };
    use halo2_gadgets::{
        ecc::{
