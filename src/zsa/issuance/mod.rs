...
use crate::{
    note::{AssetBase, AssetId, ExtractedNoteCommitment, NoteVersion, Nullifier, Rho},
...
mod tests {
    ...
    fn setup_issue_action(
        ...
        let note1 =
            Note::new_issue_note(recipient, NoteValue::from_raw(note1_value), asset, NoteVersion::V2, &mut rng);
        let note2 =
            Note::new_issue_note(recipient, NoteValue::from_raw(note2_value), asset, NoteVersion::V2, &mut rng);
    ...
    fn action_verify_incorrect_asset_base() {
        ...
        let note1 = Note::new_issue_note(recipient, NoteValue::from_raw(10), asset, NoteVersion::V2, &mut rng);
        let note2 = Note::new_issue_note(recipient, NoteValue::from_raw(20), wrong_asset, NoteVersion::V2, &mut rng);
