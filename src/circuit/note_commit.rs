...
#[derive(Clone, Debug)]
pub(crate) struct PkdCanonicity {
...
#[derive(Clone, Debug)]
pub(crate) struct ValueCanonicity {
...
#[derive(Clone, Debug)]
pub(crate) struct RhoCanonicity {
...
#[derive(Clone, Debug)]
pub(crate) struct PsiCanonicity {
